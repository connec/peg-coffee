(function() {
  ...
  module.exports = Parser = (function() {
    ...
    Parser.prototype.action = function() {
      var action, args, ctx, expression, i, result;
      expression = arguments[0], args = 3 <= arguments.length ? slice.call(arguments, 1, i = arguments.length - 1) : (i = 1, []), action = arguments[i++];
      this.push_context();
      if (result = expression.apply(this, args)) {
        ctx = this.pop_context();
        ctx.$$ = result.value;
        return new this.Result(action.call(this.parse_context, ctx));
      } else {
    ...
    Parser.prototype.push_context = function() {
      return this.action_contexts.push({});
    };
    ...
    Parser.prototype.pop_context = function() {
      return this.action_contexts.pop();
    };
