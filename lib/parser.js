(function() {
  ...
  module.exports = Parser = (function() {
    ...
    Parser.prototype.action = function() {
      var action, args, context, expression, i, result;
      ...
      if (result = expression.call.apply(expression, [this, context].concat(slice.call(args)))) {
        ...
        return new this.Result(action.call(this.parse_context, context));
      } else {
        return result;
      }
    };
    ...
    Parser.prototype.label = function() {
      ...
      context[name] = (result = expression.call.apply(expression, [this, context].concat(slice.call(args)))) ? result.value : null;
      return result;
    };
    ...
    Parser.prototype._backtrack = function() {
      ...
      sub_context = context != null ? Object.create(context) : context;
